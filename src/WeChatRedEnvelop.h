...
#define WBFont(size) [UIFont systemFontOfSize:FIX_FONT_SIZE(size)]
#define RGBA(r, g, b, a) [UIColor colorWithRed:(r) / 255.0 green:(g) / 255.0 blue:(b) / 255.0 alpha:(a)]
#define RGB(r, g, b) RGBA(r, g, b, 1)

typedef NS_ENUM(NSUInteger, WBArrayTpye) {
    WBArrayTpyeMsgWrap,
    WBArrayTpyeMsgUserName
};
