//
//  WBChatRoomSensitiveViewController.m
//  test
//
...
- (void)settingSensitiveSwitch:(UISwitch *)arg {
    [[WBRedEnvelopConfig sharedConfig] setChatRoomSensitiveEnable:arg.on];
    [self reloadTableData];
}
...
- (void)addSensitiveAction {
    ...
    [editVC setEndEditing:^(NSString *text) {
        ...
        [[WBRedEnvelopConfig sharedConfig] setChatRoomSensitiveArray:self.chatRoomSensitiveArray];
        [self reloadTableData];
    }];
