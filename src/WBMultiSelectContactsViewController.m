//
//  WBMultiSelectContactsViewController.m
//  test
//
...
@interface WBMultiSelectContactsViewController ()
...
@implementation WBMultiSelectContactsViewController
...
- (void)onNext {
    ...
    editVC.text = [[WBRedEnvelopConfig sharedConfig] allChatRoomDescText];
    editVC.title = @"请输入群公告";
    [editVC setEndEditing:^(NSString *text) {
        [[WBRedEnvelopConfig sharedConfig] setAllChatRoomDescText:text];
        CContactMgr *contactMgr = [[objc_getClass("MMServiceCenter") defaultCenter] getService:objc_getClass("CContactMgr")];
        CContact *selfContact = [contactMgr getSelfContact];
